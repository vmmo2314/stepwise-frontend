						...
						<div className="">
							<form >
								<div className="modal-header">
									...
									<button type="button" className="btn close lineheight1" onClick={()=> setPostModal(false)}>
										<span>×</span>
									</button>
								</div>
										...
										<div className="add-contact-content">
											<div className="image-placeholder">	
											 ...
											 <div className="form-group mb-3">
												<label className="text-black font-w500">Customer Id </label><span className='required'>*</span>
                                            ...
                                            <div className="form-group mb-3">
												<label className="text-black font-w500">Deadline Date</label><span className='required'>*</span>
												<div className="contact-name">
													<input type="text"  className="form-control"  autocomplete="off"
                                            ...
                                            <div className="form-group mb-3">
												<label className="text-black font-w500">Client</label><span className='required'>*</span>
											...
											<div className="form-group mb-3">
												<label className="text-black font-w500">Location</label><span className='required'>*</span>
												<div className="contact-occupation">
													<input type="text"  autocomplete="off"
						...
						<div className="">
							<form >
								<div className="modal-header">
									...
									<button type="button" className="btn close lineheight1" onClick={()=> setEditModal(false)}>
										<span>×</span>
									</button>
								</div>
								<div className="modal-body">
                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <div className="text-dark fs-14 text-nowrap"><i className="fas fa-calendar me-3"></i>Created on Sep 8th, 2023</div>
                                </div>
                                <Dropdown className="">
