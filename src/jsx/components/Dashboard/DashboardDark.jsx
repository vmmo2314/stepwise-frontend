      ...
      <div>
         <div className="form-head d-flex mb-3 mb-md-4 align-items-start">
            <div className="me-auto d-none d-lg-block">
               <h3 className="text-black font-w600">!Bienvenido a CSF(RANCIO)!</h3>
               <p className="mb-0 fs-18">Sistema de control y seguimiento</p>
            </div>
         ...
         <div className="row">
            ...
            <div className="col-xl-3 col-xxl-4 ">
               <div className="card">
                  ...
                  <div className="card-body">
                     <div>
                        <span className="text-info fs-26 font-w600 me-3">
                           $41,512k
                        </span>
