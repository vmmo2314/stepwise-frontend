            ...
            <div className="col-xl-12">
               <div className="card">
                  <div className="card-body">
                     <div className="row">
                        <div className="col-xl-4 order-xl-2 mb-4">
                        ...
                        <div className="col-xl-8 order-xl-1">
                           ...
                           <form className="needs-validation" noValidate="">
                              ...
                              <div className="row">
                                 ...
                                 <div className="col-md-6 mb-3">
                                    <label  className="form-label" htmlFor="cc-number">
                                       Credit card number
                                    </label>
                                    <input
                                       type="text"
                              ...
                              <div className="row">
                                 <div className="col-md-3 mb-3">
                                    <label  className="form-label" htmlFor="cc-expiration">
                                       Expiration
                                    </label>
                                    <input
                                       type="text"
                                 ...
                                 <div className="col-md-3 mb-3">
                                    <label  className="form-label" htmlFor="cc-expiration">CVV</label>
                                    <input
                                       type="text"
                                       className="form-control"
                                       id="cc-cvv"
