                  ...
                  <div className="product-detail-content">
                    ...
                    <div className="new-arrival-content pr">
                      <h4>Solid Women's V-neck Dark T-Shirt</h4>
						...
						<p>
							Product tags:&nbsp;&nbsp;
							<span className="badge badge-primary light me-1">bags</span>
                      ...
                      {/*Quantity start*/}
						<div className="col-2 px-0 col-md-4 col-lg-3">
            ...
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button
                  ...
                  className="btn close lineheight1"                  
                >
                  <span>×</span>
                </button>
              </div>
                      ...
                      <div className="rating-stars">
                        ...
                        >
						  {[1,2,3,4,5].map((data, i)=>(
                              <li key={i}
                              className={`star ${data <= rating && 'selected'  }`}
                              onClick={()=>
                                {
                                  setRating(data);
                            ...
                            >
                              <i className="fa fa-star fa-fw me-1" />
                            </li>
                          ))}  
                        </ul>
                      </div>
